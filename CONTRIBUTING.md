# Contributing to Metainfo

:balloon: Thanks for your help improving the project! We are so happy to have you!

There are opportunities to contribute to Metainfo at any level. It doesn't matter if
...
<img src="https://github.com/cloudwego/metainfo/raw/main/.github/assets/volo-feishu-dev-group.png" alt="Volo dev group" width="50%" height="50%" />

_This guide is adapted from the [Tokio contributing guide](https://github.com/tokio-rs/tokio/blob/master/CONTRIBUTING.md)_.

## Conduct

See the [Code of Conduct](https://github.com/cloudwego/metainfo/blob/main/CODE_OF_CONDUCT.md).
...
1. By opening the issue for discussion: For instance, if you believe that you
   have discovered a bug in Metainfo, creating a new issue in [the cloudwego/metainfo
...
3. By helping to resolve the issue: Typically this is done either in the form of
   ...
   Metainfo in a concrete and reviewable manner.

[issue]: https://github.com/cloudwego/metainfo/issues
...
When opening a new issue in the Metainfo issue tracker, you will be presented
...
cases should be limited, as much as possible, to using only Metainfo APIs.
...
functional guidelines of the Metainfo project.

## Pull Requests

Pull Requests are the way concrete changes are made to the code, documentation,
and dependencies in the Metainfo repository.
...
example), it is either adding new functionality to Metainfo or it is fixing
existing, broken functionality. In both of these cases, the pull request should
include one or more tests to ensure that Metainfo does not regress in the future.
...
**Any Metainfo community member is welcome to review any pull request**.

All Metainfo contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for Metainfo?
2. Does this change make Metainfo better, even if only incrementally?
...
avoid stalling the Pull Request. Most nits can typically be fixed by the Metainfo
...
a particular change that makes Metainfo better, but the individual might just not
want to have anything to do with Metainfo ever again. The goal is not just having
good code.
...
The Metainfo GitHub repository has a lot of issues and PRs to keep track of. This
...
The area label describes the crates relevant to this issue or PR.
 ...
 - **A-metainfo** This issue concerns the main `metainfo` crate.
